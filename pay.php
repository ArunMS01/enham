...
//     $customer_addressf = $_POST['customer_addressf'];
//     $customer_addrest = $_POST['customer_addrest'];
//     $customer_city = $_POST['customer_city'];
//     $customer_state = $_POST['customer_state'];
//     $customer_zip = $_POST['customer_zip'];
//     $total_price = $_POST['total_price'];
//     $payment_info = $_POST['payment_method'];
...
if(isset($_GET['checkout']) and in_array($_GET['checkout'], ['manual'], true)){
