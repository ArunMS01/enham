    ...
    <div class="container">
        ...
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-5" id="load_more_product">
            ...
            if (isset($_GET['search'])) {
                $productsearch = new SearchController;
                $price_filter = '';
                $sorting = '';
                ...
                $getProduct = $productsearch->getsearchProduct($_GET['search'], $price_filter, $sorting);
                // print_r($getProduct);
            }
            // print_r($getProduct);
            if ($getProduct) {
                            ...
                            <div class="col products-column">
                                <div class="product-card">
                                    <div class="product-media">
                                        ...
                                        ?>
                                        <a class="product-image" href="<?php echo SITE_URL ?>product.php?url=<?php echo $category_products['url'] ?>">
                                    ...
                                    <div class="product-content product-cart-box">
                                        ...
                                        <h6 class="product-name"><a href="<?php echo SITE_URL ?>product.php?url=<?php echo $category_products['url']; ?>"><?php echo substr(strip_tags($category_products['name']), 0, 20) . '...'; ?></a></h6>
                                        ...
                                        ?>
                                            <div class="product-action-1">
                                                <button data-productid="<?php echo $category_products['id'] ?>" class="product-add" title="Add to Cart"><i class="fas fa-shopping-basket"></i><span>add</span></button>
                                                <div class="product-action hhh"><button data-productid="<?php echo $category_products['id'] ?>" class="action-minus add_to_cart_btn" title="Quantity Minus"><i class="icofont-minus"></i></button>
                                                    <input disbaled type="text" value="1" max="<?php echo $stock_left ?>" id="" value="1" title="Quantity Number" name="qtybutton" class="cart-quantity action-input cart-plus-minus-box">
                                            ...
                                            ?>
                                                <div class="product-action-1">
                                                    <button data-productid="<?php echo $category_products['id'] ?>" class="product-add" title="Add to Cart"><i class="fas fa-shopping-basket"></i><span>add</span></button>
                                                    <div class="product-action hjj"><button data-productid="<?php echo $category_products['id'] ?>" class="action-minus add_to_cart_btn" title="Quantity Minus"><i class="icofont-minus"></i></button>
                                                        <input disabled type="text" value="1" max="<?php echo $category_products['quantity'] ?>" id="" value="1" title="Quantity Number" name="qtybutton" class="cart-quantity action-input cart-plus-minus-box">
                                                        <button data-productid="<?php echo $category_products['id'] ?>" class="action-plus add_to_cart_btn" title="Quantity Plus"><i class="icofont-plus"></i></button>
                                                    </div>
                                                </div>
                                            <?php
