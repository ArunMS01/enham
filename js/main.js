...
$("#cart_products").on("click", '.action-plus', (function ()
{
    var $button = $(this);
...
})), $("#cart_products").on("click", '.action-minus', (function ()
{    
    var currentminval = $(this).closest(".product-action").children(".action-input").get(0).value;
    if(currentminval >1){
