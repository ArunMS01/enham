...
class CancelorderController
{
    ...
    public function ordercancel($orderitem_id, $cancel_status, $cancel_reason, $product_images){

        $sql ="UPDATE order_items_status SET item_status = '$cancel_status', cancel_reason = '$cancel_reason', images = '$product_images' WHERE order_item_id ='$orderitem_id'";
