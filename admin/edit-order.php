...
if (isset($_POST["create_pdf"])) {
    ...
    $obj_pdf->SetTitle("Download Invoice Enham");
    ...
    $orders = new OrderController;
       ...
       $getorder_items = $orders->getorderItems($orderid);
                if($getorder_items){
                    foreach($getorder_items as $getsitems){
                        $main_order_id = $getsitems['order_id'];
                    }
                }
    

    $result = $orders->editorder($main_order_id);
    if ($result) {
        $content .= '
    ...
    <tr>
        <td><b>Payment Info:</b> ' . $result['payment_info'] . '
        </td>
...
<td style="text-align:right;">' . $result['ship_zone'] . ' ' . ' ' . $result['ship_country'] . ' ' . ' <br> ' .  $result['ship_zip'] . ' </td>
    ...
    $content .= '
      <h3 align="center">Thanks For Shopping With Enham</h3><br /><br />  
    ...
    if ($getorder_items) {
        ...
        ';
            $singleproduct_total = 0;
            $total_items_price = $orderitem['quantity'] * $product_price;
            $singleproduct_total = $singleproduct_total + $total_items_price;
            $count++;
        }
    ...
    <td style = "text-align:right;">' . number_format($singleproduct_total, 2) . '</td>
</tr>
        ';
    }
    $content .= '
      ...
      <p><u>Thanks For Shopping With Enham</u><br/>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <ul class="order_list_xs">
                        ...
                        <li><strong>Payment Id: </strong><?php
                        if($payment_id){
                            echo "$payment_id";
                        }
                        ?></li>
                                            ...
                                            <tbody>
                                                ...
                                                if ($getorder_items) {
                                                    ...
                                                    foreach ($getorder_items as $orderitem) {
                                                         ...
                                                         $singleproduct_total = 0;
            $total_items_price = $orderitem['quantity'] * $orderitem['total'];
            $singleproduct_total = $singleproduct_total + $total_items_price;
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <form action="codes/orders.php" class="status_order_form" method="POST">
                                                                    ...
                                                                    // }
                                                                    ?>
                                                                    <input type="hidden" name="orderId" value="<?php echo $main_order_id; ?>">
                                                    ...
                                                    <tr>
                                                        <td colspan="5">
                                                            Total: <strong>&#x20B9; <?php echo $singleproduct_total ?></strong>
                                                        </td>
                                                    </tr>
                                ...
                                <div class="col-md-12">
                                    <?php
                                        if ($getorder_items) {
                                            ...
                                            foreach ($getorder_items as $orderitem) {
                                              $allitemstatus =  $orders->getallorderitemstatus($orderitem['id']);
                                              if($allitemstatus){

                                                foreach($allitemstatus as $itemstatus){
                                                    if(!empty($itemstatus['cancel_reason'])){                                    ?>
                                        <p>Product <?php echo $itemstatus['item_status'];?> and the reason is <strong style="color:red;"><?php echo $itemstatus['cancel_reason']?> .</strong></p>
                                        <div>
                                          <a href="assets/cancel-order-images/<?php echo $itemstatus['images']?>">  <img style="width:100px" src="assets/cancel-order-images/<?php echo $itemstatus['images']?>" alt=""></a>
                                        </div>
                                    <?php
                                                    }
                                                }
            ...
            $singleproduct_total = $singleproduct_total + $total_items_price;
                                            ...
                                            ?>
                                            &#x20B9; <?php echo $singleproduct_total ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
