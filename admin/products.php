    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <button class="btn btn-danger" id="delete-multiple">Delete</button>
                        ...
                        <table class="table" id="myproductTable">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            <td>
                                                <input type="checkbox" class="deletemultiple" value="<?php echo $row['id']; ?>">
                                                <?php echo $count; ?>
                                            </td>
                                            <td>
                                                <p>
                                                    <?php echo substr(strip_tags($row['name']), 0, 30) . '...'; ?>
                                                </p>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                        <span class="badge badge-info"><?php echo $catname; ?></span><br>
                                                <?php
...
<script>
    ...
    $('#delete-multiple').click(function(){
        var checkbox = $('.deletemultiple:checked');
        if(checkbox.length > 0)
        {
            ...
            $.ajax({
                url:"codes/product.php",
                method:"POST",
                data:{checkbox_value:checkbox_value, action:"delete_multiple_products"},
                success:function()
                {
                    location.reload();
                }
