...
class CategoryController
{
    ...
    public function create($inputdata)
    {
        ...
        // echo $data;
       $categoryQuery = "INSERT INTO category (cat_name, cat_url, cat_description, category_image, created_on) VALUES ($data)";
    ...
    {
        $getCategories = "SELECT * FROM category ORDER BY ID DESC";
    ...
    $category_image = $inputData['category_image'];
     
        $cat_url =  $inputData['categoryurl'];
        $cat_description =  $inputData['categorydescription'];
   $updateCatgeory = "UPDATE category SET cat_name = '$name', cat_url ='$cat_url', cat_description = '$cat_description'";
        if(!empty($category_image)){
        $updateCatgeory .= " , category_image = '$category_image'";
        }
       $updateCatgeory .= " WHERE id = '$category_id'";
