            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        if ($result) {
                        ?>
                            <form action="codes/subcategory-code.php" enctype="multipart/form-data" method="POST" onsubmit="return Validate()">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="parent_category" class="form-control" id="">
                                        ...
                                        if ($getcategory) {
                                            ...
                                            ?>
                                                <option <?php if($result['category_id'] == $category['id']){echo "selected";}?>  value="<?php echo $category['id']; ?>"><?php echo $category['cat_name'] ?></option>
                                        <?php
                                            }
                                        }
                                        ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <img style="width:60px" src="assets/subcategory-images/<?php echo $result['subcat_image'] ?>" alt="">
                                </div>
